...
--
-- PG: Added if exists option to avoid error message if table doesnt exist.
drop table if exists f_fieldtofield;

-- PG: To check: Use TRUNCATE instead of drop table to 
-- truncate table f_fieldtofield;
...
drop table if exists f_fieldtofield_l2;
drop table if exists f_fieldtofield_l2z;
--
...
drop table if exists f_fieldtofield_l3z;
drop table if exists f_fieldtofield_l3;
...
drop table if exists f_fieldtofield_l4z;
drop table if exists f_fieldtofield_l4;
