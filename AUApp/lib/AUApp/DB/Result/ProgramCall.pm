use utf8;
package AUApp::DB::Result::ProgramCall;
...
=head1 TABLE: C<program_call>

=cut

__PACKAGE__->table("program_call");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vtcdJ9QeKVRyo4BIhlhIEw
