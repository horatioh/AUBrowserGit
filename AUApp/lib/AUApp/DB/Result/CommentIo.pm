use utf8;
package AUApp::DB::Result::CommentIo;
...
AUApp::DB::Result::CommentIo - Comments related to input_output
...
=head1 TABLE: C<comment_io>

=cut

__PACKAGE__->table("comment_io");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5Nt01MgD0qeB1IYeIhovxA
