use utf8;
package AUApp::Auswertung::Result::AuExtensionFInputDatei;
...
AUApp::Auswertung::Result::AuExtensionFInputDatei
...
=head1 TABLE: C<au_extension.f_input_datei>

=cut

__PACKAGE__->table("au_extension.f_input_datei");
