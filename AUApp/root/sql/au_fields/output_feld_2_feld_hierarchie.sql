...
select 
 ...
 el.output_feld_id      as output_feld_id ,
 f2f.id                 as id             ,
...
select
 ...
 l1.output_feld_id      as output_feld_id ,
 f2f.id                 as id             ,
 f2f.program_id         as program_id     , 
 f2f.flow_id            as flow_id        , 
 f2f.input_id           as input_id       , 
...
select
 ...
 l2.output_feld_id      as output_feld_id ,
 f2f.id                 as id             ,
 f2f.program_id         as program_id     , 
 f2f.flow_id            as flow_id        , 
 f2f.input_id           as input_id       , 
...
select
 ...
 l3.output_feld_id      as output_feld_id ,
 f2f.id                 as id             ,
 f2f.program_id         as program_id     , 
 f2f.flow_id            as flow_id        , 
 f2f.input_id           as input_id       , 
...
select
 ...
 l4.output_feld_id      as output_feld_id ,
 f2f.id                 as id             ,
 f2f.program_id         as program_id     , 
 f2f.flow_id            as flow_id        , 
 f2f.input_id           as input_id       , 
...
select
 ...
 l5.output_feld_id      as output_feld_id ,
 f2f.id                 as id             ,
 f2f.program_id         as program_id     , 
 f2f.flow_id            as flow_id        , 
 f2f.input_id           as input_id       , 
...
select
 ...
 l6.output_feld_id      as output_feld_id ,
 f2f.id                 as id             ,
 f2f.program_id         as program_id     , 
 f2f.flow_id            as flow_id        , 
 f2f.input_id           as input_id       , 
...
select
 ...
 l7.output_feld_id      as output_feld_id ,
 f2f.id                 as id             ,
 f2f.program_id         as program_id     , 
 f2f.flow_id            as flow_id        , 
 f2f.input_id           as input_id       , 
...
select
 ...
 l8.output_feld_id      as output_feld_id ,
 f2f.id                 as id             ,
 f2f.program_id         as program_id     , 
 f2f.flow_id            as flow_id        , 
 f2f.input_id           as input_id       , 
...
from 
 l8                                       , 
 f_fieldtofield         as f2f 
where l8.source_id      =  f2f.target_id
and   not exists (select 0 from exclude_pgm ep where f2f.program_id = ep.id)
and   not exists (select 0 from l1             where l1.program_id  = f2f.program_id)
and   not exists (select 0 from l2             where l2.program_id  = f2f.program_id)
and   not exists (select 0 from l3             where l3.program_id  = f2f.program_id)
...
select
 ...
 l9.output_feld_id      as output_feld_id ,
 f2f.id                 as id             ,
 f2f.program_id         as program_id     , 
 f2f.flow_id            as flow_id        , 
 f2f.input_id           as input_id       , 
...
from 
 l9                                       , 
 f_fieldtofield         as f2f 
where l9.source_id      =  f2f.target_id
and   not exists (select 0 from exclude_pgm ep where f2f.program_id = ep.id)
and   not exists (select 0 from l1             where l1.program_id  = f2f.program_id)
and   not exists (select 0 from l2             where l2.program_id  = f2f.program_id)
and   not exists (select 0 from l3             where l3.program_id  = f2f.program_id)
...
select
 ...
 l10.output_feld_id     as output_feld_id ,
 f2f.id                 as id             ,
 f2f.program_id         as program_id     , 
 f2f.flow_id            as flow_id        , 
 f2f.input_id           as input_id       , 
...
from 
 l10                                      , 
 f_fieldtofield         as f2f 
where l10.source_id     =  f2f.target_id
and   not exists (select 0 from exclude_pgm ep where f2f.program_id = ep.id)
and   not exists (select 0 from l1             where l1.program_id  = f2f.program_id)
and   not exists (select 0 from l2             where l2.program_id  = f2f.program_id)
and   not exists (select 0 from l3             where l3.program_id  = f2f.program_id)
...
select
 l.level         as level ,
 l.output_feld_id as output_feld_id ,
