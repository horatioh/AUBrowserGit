...
__PACKAGE__->add_columns(
  ...
  "parent",
  { accessor => undef, data_type => "bigint", is_nullable => 1 },
  "physical",
  { data_type => "bigint", is_nullable => 1 },
  "redefine",
  { data_type => "bigint", is_nullable => 1 },
...
# Created by DBIx::Class::Schema::Loader v0.07045 @ 2016-09-21 13:35:25
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ldf8sAn6NPJsDr6ysYG0bg
